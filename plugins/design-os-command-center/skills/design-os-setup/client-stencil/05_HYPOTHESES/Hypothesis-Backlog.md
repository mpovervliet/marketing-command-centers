...
Elke hypothese volgt het vaste format hieronder. Hypothesen komen voort uit de data-baseline (fase 2) en de diagnose (fase 3). Prioritering via ICE in `Impact-Effort-Matrix.md` of direct als ICE-veld per hypothese.
...
- **Bewijs:** E-GA4-FUNNEL-001 (grote drop stap 1), E-SURVEY-PRIJS-001 (prijs = blokkade #1), E-REVIEW-PRIJS-001 (klacht "prijs hoger dan verwacht").

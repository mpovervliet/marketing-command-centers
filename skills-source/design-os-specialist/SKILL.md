...
| 4 Strategie | Beslismomenten (BM-X), conversion architecture, site-structuur | 03_SITE-STRUCTURE, 04_STRATEGY | Decision-Moment-Map af, kern-flow benoemd, open oorzaken gemarkeerd |
...
| 8 Validatie | Experimenten, readouts, learnings | 07_VALIDATION | Learning Records verwerkt in registry, statuswijzigingen (WINNER naar PERMANENT, LOSER naar BLOCKED) doorgevoerd |
...
Let op: mapnummers zijn geen fasenummers. Fase 6 schrijft naar 09_DECISION-LOG, fase 7 naar 06_DESIGN plus Figma, fase 8 naar 07_VALIDATION en fase 9 naar 08_HANDOFF. Leidend is deze tabel, niet het nummer van de map. Dezelfde nummering staat in `00_PLAN/Definition-of-Done.md` en `00_PLAN/Plan-van-Aanpak.md`; wijkt de klantmap daarvan af, dan is de klantmap verouderd en meld je dat aan de lead.

...
- **design-os-experience-motion**: eigenaar van de belevingslaag. Routeer hierheen zodra een ontwerp "te standaard" of "te statisch" heet, zodra een opdrachtgever om interactie, animatie of merkbeleving vraagt, en zodra een DDR beweging vastlegt. Levert de Story Spine (fase 5b naar 6), de motion-tokens in 07_DESIGN-SYSTEM, de Motion Spec per DDR en de motion-poort die het Red Team als veto draait. Bewaak dat beweging dezelfde gate haalt als elke andere keuze: een pagina met beweging zonder Motion Spec gaat niet door.
